...
const appName = "Coop Game";
const packageName = "com.coop.game";
...
const databaseUrl = "https://panel.coopcoin.info";
...
final payoutMethods = [
  ...
  PayoutMethod(
    ...
    inputDetailsFromUser: const ["Enter Coop Coin wallet Adress"],
    inputDetailsIsNumber: const [false],
    image: "assets/images/coop.svg",
    type: "coop coin",
  )
