          ...
          CustomRoundedButton(
            ...
            onTap: () {
              ...
              if (enteredRedeemAmount.isEmpty ||
                ...
                UiUtils.setSnackbar(
                    "${AppLocalization.of(context)!.getTranslatedValues(minimumRedeemableAmountKey)} ${context.read<SystemConfigCubit>().payoutRequestCurrency}${_minimumRedeemableAmount()} ",
                    context,
                    false);
                return;
              }
